...
public:
    ...
    bool running_in_this_thread(const implementation_type& impl)
    {
...
private:
        ...
        struct on_invoker_exit
        {
            ...
            ~on_invoker_exit()
            {
                ...
                if (more_handlers)
                {
                    ...
                    ex.post(std::move(*this), allocator);
                }
            }
    ...
    void dispatch(const implementation_type& impl, Executor& ex, Function&& function,
                  const Allocator& a, bool prioritized)
    {
        ...
        if (running_in_this_thread(impl))
        {
            ...
            function_type tmp(std::move(function));
    ...
    template <typename Executor, typename Function, typename Allocator>
    void post(const implementation_type& impl, Executor& ex, Function&& function,
              Allocator a)
    {
        using function_type = std::decay_t<Function>;
    ...
    template <typename Executor, typename Function, typename Allocator>
    void defer(const implementation_type& impl, Executor& ex, Function&& function,
               Allocator a)
    {
